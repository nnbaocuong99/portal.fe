...
interface DistrictDetailDrawerProps extends DrawerProps {
  model: District;
  ...
  dispatch?: React.Dispatch<ModelAction<District>>;
  loading?: boolean;
}

function DistrictDetailDrawer(props: DistrictDetailDrawerProps) {
  ...
  const [statusList] = filterService.useEnumList<Status>(
    districtRepository.singleListStatus
  );
                    ...
                    >
                      <Select
                        ...
                        onChange={handleChangeSelectField({
                          fieldName: nameof(model.province),
                        })}
                  ...
                  <Col lg={24} className="m-b--sm m-t--sm">
                    ...
                    >
                      <InputNumber
                        ...
                        placeHolder={translate(
                          "districts.placeholder.priority"
                        )}
                        onChange={handleChangeSingleField({
...
export default DistrictDetailDrawer;
